        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotosFolder = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailabilityOfProducts", x => x.Id);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersShoppingCartItems", x => x.Id);
                    table.UniqueConstraint("AK_UsersShoppingCartItems_UserId_Size_ProductId", x => new { x.UserId, x.Size, x.ProductId });
                    table.ForeignKey(
                        name: "FK_UsersShoppingCartItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersItems", x => new { x.OrderId, x.ProductId, x.Size });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersShoppingCartItems_ProductId",
